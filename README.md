...
| On a Jetson Orin Nano? | Not yet: ~16 FPS after optimization (13 before); the CPU, not the GPU, is the bottleneck |
...
<!-- replay-table:start -->
*(tables regenerated with the Jetson optimized pass)*
<!-- replay-table:end -->
